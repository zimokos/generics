...
public class MyDictionary<K, V> implements Book<K, V> {
    ...
    public boolean insert(final K key, final V value) {
        ...
        for (Node<K, V> node : nodeList) {
            if (keyExistButValueNew(node, newNode, value) || collisionsProcessing(node, newNode, nodeList)) {
                return true;
            }
        }
    ...
    private boolean collisionsProcessing(final Node<K, V> nodeFromList, final Node<K, V> newNode, final List<Node<K, V>> nodes) {
